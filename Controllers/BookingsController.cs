...
namespace FastxWebApi.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        public async Task<ActionResult<PagenationResponseDTO<BookingResponseDTO>>> GetAllBookings([FromQuery] PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        [HttpGet("{id}")]
        [Authorize(Roles = "Admin,Bus Operator,User")]
        ...
        public async Task<ActionResult<PagenationResponseDTO<BookingResponseDTO>>> GetBookingsByBusId([FromRoute]int busId, [FromQuery]PagenationRequestDTO pagenation)
        {
            try
            {
