...
namespace FastxWebApi.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public async Task<ActionResult<PagenationResponseDTO<PaymentDisplayDTO>>> GetAllPayments(PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PaymentDisplayDTO>> GetPaymentByBookingId(int bookingId)
        {
            try
            {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PagenationResponseDTO<PaymentDisplayDTO>>> GetPaymentsByUserId(int userId, PagenationRequestDTO pagenation)
        {
            try
            {
