...
namespace FastxWebApi.Controllers
{
    ...
    public class RouteController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PagenationResponseDTO<RouteDTO>>> GetAllRoutes( PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        public async Task<ActionResult<PagenationResponseDTO<RouteDTO>>> SearchRoutes( string origin, string destination, DateTime travelDate,  PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> UpdateRoute(int id, RouteDTO routeDTO, int busOperatorId)
        {
