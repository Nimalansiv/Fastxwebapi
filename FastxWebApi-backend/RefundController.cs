...
namespace FastxWebApi.Controllers
{
    ...
    public class RefundController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PagenationResponseDTO<RefundDTO>>> GetAllRefunds(PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PagenationResponseDTO<RefundDTO>>> GetPendingRefunds(PagenationRequestDTO pagenation)
        {
            try
            {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<PagenationResponseDTO<RefundDTO>>> GetRefundsByUserId(int userId, PagenationRequestDTO pagenation)
        {
            try
            {
